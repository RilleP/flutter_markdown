...
class MarkdownBuilder implements md.NodeVisitor {
  ...
  MarkdownBuilder({this.delegate, this.styleSheet, this.textAlign, this.imageDirectory});
  ...
  List<Widget> _mergeInlineChildren(_InlineElement inline) {
    ...
    for (Widget child in inline.children) {
      if (mergedTexts.isNotEmpty && mergedTexts.last is RichText && child is RichText) {
        ...
        List<TextSpan> children = previous.text.children != null ? new List.from(previous.text.children) : [previous.text];
